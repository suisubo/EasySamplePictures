<?php /* Smarty version Smarty-3.1.19, created on 2016-08-19 17:18:23
         compiled from "C:\Personal\XAMPP\htdocs\prestashopV3\themes\default-bootstrap\shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2460757b7233f8fb900-21913950%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b51c1af1fe6d27ae954bdf7afdbb12854bb02452' => 
    array (
      0 => 'C:\\Personal\\XAMPP\\htdocs\\prestashopV3\\themes\\default-bootstrap\\shopping-cart-product-line.tpl',
      1 => 1466017276,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2460757b7233f8fb900-21913950',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57b72342d5c204_27391469',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b72342d5c204_27391469')) {function content_57b72342d5c204_27391469($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\Personal\\XAMPP\\htdocs\\prestashopV3\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_modifier_regex_replace')) include 'C:\\Personal\\XAMPP\\htdocs\\prestashopV3\\tools\\smarty\\plugins\\modifier.regex_replace.php';
?>
...
<?php $_tmp63=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp61."&amp;ipa=".$_tmp62."&amp;id_address_delivery=".$_tmp63."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp66=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp64."&amp;ipa=".$_tmp65."&amp;id_address_delivery=".$_tmp66."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp69=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp67."&amp;ipa=".$_tmp68."&amp;id_address_delivery=".$_tmp69."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
