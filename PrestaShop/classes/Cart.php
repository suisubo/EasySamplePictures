...
//         }
        ...
        $product = new ServiceProduct($id_product, false, Configuration::get('PS_LANG_DEFAULT'), $shop->id);
...
//             }
            ...
            $order_total += $price * (int)$product['cart_quantity'];
        }
    ...
    */
    public function getSummaryDetails($id_lang = null, $refresh = false)
    {
        ...
        $summary = array(            
            ...
            'total_price' => $this->getOrderTotal(false)            
        );        
