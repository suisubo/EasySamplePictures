			...
			<div class="product-container" itemscope itemtype="https://schema.org/Product">
				...
				<div class="right-block">
					...
					<div class="button-container">
					    {capture}add=1&amp;id_service_product={$product.id_service_product|intval}{if isset($static_token)}&amp;token={$static_token}{/if}{/capture}
						<a class="button ajax_add_to_cart_button btn btn-default" href="{$link->getPageLink('cart', true, NULL, $smarty.capture.default, false)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Add to cart'}" data-id-product="{$product.id_service_product|intval}">
