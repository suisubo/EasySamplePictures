...
<div id="service-products_block_right" class="block products_block">
	<h4 class="title_block"><a href="{$link->getPageLink('service-products')|escape:'html'}" title="{l s='Service products' mod='blockserviceproducts'}">{l s='New products' mod='blockserviceproducts'}</a></h4>
